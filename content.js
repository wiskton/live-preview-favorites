...
Object.assign(previewTitle.style, {
    color:"#efeff1", fontSize:"13px", marginTop:"2px",
    whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis"
});
...
document.addEventListener("mouseover", e => {
    ...
    previewTitle.style.color = "#efeff1";
    previewTitle.textContent = "...";
    
    const platform = a.href.includes("kick.com") ? "kick" : "twitch";
    
    getTitle(ch, platform).then(t => {
        if (previewCh === ch) {
            previewTitle.textContent = t || "";
            if (t && (t.toLowerCase().includes("rerun") || t.toLowerCase().includes("reprise"))) {
                previewTitle.style.color = "#ff4f4d";
            }
        }
    });
